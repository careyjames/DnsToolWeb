	...
	return []BrandColor{
		{
			...
			Value:     "#cc0000",
			Notes:     "CVSS v3.1 Critical severity. Immediate remediation required.",
			Source:    "FIRST CVSS v3.1 / NVD",
		...
		},
		{
			...
			Value:     "#df3d03",
			Notes:     "CVSS v3.1 High severity. Priority remediation.",
			Source:    "FIRST CVSS v3.1 / NVD",
			SourceURL: "https://www.first.org/cvss/v3-1/specification-document",
		},
		{
			...
			Value:     "#f9a009",
			Notes:     "CVSS v3.1 Medium severity. Scheduled remediation.",
			Source:    "FIRST CVSS v3.1 / NVD",
			SourceURL: "https://www.first.org/cvss/v3-1/specification-document",
		},
		{
			...
			Value:     "#ffcb0d",
			Notes:     "CVSS v3.1 Low severity. Remediation as resources allow.",
			Source:    "FIRST CVSS v3.1 / NVD",
			SourceURL: "https://www.first.org/cvss/v3-1/specification-document",
		},
		{
			...
			Value:     "#53aa33",
			Notes:     "CVSS v3.1 No vulnerability / informational.",
			Source:    "FIRST CVSS v3.1 / NVD",
			SourceURL: "https://www.first.org/cvss/v3-1/specification-document",
		},
	}
