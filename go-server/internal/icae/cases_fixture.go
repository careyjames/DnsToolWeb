...
//
// Golden Fixture Test Cases — End-to-end accuracy validation.
//
                ...
                },
                {
                        ...
                        RunFn: func() (string, bool) {
                                ...
                                tlsa1, valid1 := analyzer.ExportParseTLSAEntry(
                                        ...
                                        "mail.example.com", "_25._tcp.mail.example.com",
                                )
                                ...
                                hostsWithDANE := []string{"mail.example.com", "mail2.example.com"}
...
func noMailDomainFixtures() []TestCase {
        return []TestCase{
                ...
                },
                {
                        ...
                        RunFn: func() (string, bool) {
                                count, _, _, perm, _, _, noMail := analyzer.ExportParseSPFMechanisms("v=spf1 -all")
                                status, _ := analyzer.ExportBuildSPFVerdict(count, perm, noMail, []string{"v=spf1 -all"}, nil)
        ...
        return []TestCase{
                ...
                },
                {
                        ...
                        RunFn: func() (string, bool) {
                                ...
                                hostsWithDANE := []string{"mail.example.com"}
