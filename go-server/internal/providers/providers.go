...
var CNAMEProviderMap = map[string]ProviderInfo{
	...
	"hubspot.net":             {Name: "HubSpot", Category: catMarketing},
	"hubspot.com":             {Name: "HubSpot", Category: catMarketing},
	"hs-sites.com":            {Name: "HubSpot", Category: catMarketing},
	...
	"salesforce.com":          {Name: "Salesforce", Category: catCRM},
	"force.com":               {Name: "Salesforce", Category: catCRM},
	"salesforceliveagent.com": {Name: "Salesforce", Category: catCRM},
	...
	"edgekey.net":             {Name: "Akamai", Category: catCDN},
	"akamaiedge.net":          {Name: "Akamai", Category: catCDN},
	"akadns.net":              {Name: "Akamai", Category: catCDN},
	"akamaized.net":           {Name: "Akamai", Category: catCDN},
	"edgesuite.net":           {Name: "Akamai", Category: catCDN},
...
var DMARCMonitoringProviders = map[string]MonitoringProvider{
	...
	"ondmarc.com":      {Name: "Red Sift OnDMARC", Capabilities: []string{capDMARCReporting, capDMARCEnforcement}},
	"redsift.cloud":    {Name: "Red Sift OnDMARC", Capabilities: []string{capDMARCReporting, capDMARCEnforcement}},
...
var DynamicServicesProviders = map[string]DynamicServiceProvider{
	...
	"no-ip.com":         {Name: "No-IP", Category: catDynamicDNS},
	"no-ip.org":         {Name: "No-IP", Category: catDynamicDNS},
	"no-ip.biz":         {Name: "No-IP", Category: catDynamicDNS},
